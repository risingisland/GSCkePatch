...
// GetSimpleCMS config file for CKeditor 4.4.7
...
CKEDITOR.editorConfig = function( config )
{
	...
	config.extraPlugins 			   = 'youtube,codemirror';

	config.toolbar_advanced = 
		[['PasteFromWord','RemoveFormat','Paste','Undo','Redo','Find','Replace','Format','FontSize','HorizontalRule','Smiley','SpecialChar','Rule','SelectAll','ShowBlocks','-','Source','Maximize'],
		'/',
		['Bold','Italic','Underline','StrikeThrough','Subscript','Superscript','Blockquote','Outdent','Indent','-','NumberedList','BulletedList','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock','-','Table','TextColor','BGColor','Link','Unlink','Youtube','Image']];	

	config.toolbar_basic = 
		[['Bold', 'Italic', 'Underline', 'NumberedList', 'BulletedList', 'JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock', 'Link', 'Unlink', 'Image', 'RemoveFormat', 'Source'],['About']];
